class InternalError(Exception):
    ...
    def __str__(self) -> str:
        return 'InternalError: {} - {}'.format(self.__error['code'].format(*self.__params['code']),
...
ERROR_REQUIRED = {
    'code': 'ERROR_{}_REQUIRED',
    'msg': '{} is required.'
}

ERROR_NOT_FOUND = {
    'code': 'ERROR_{}_NOT_FOUND',
    'msg': 'Could not found {}.'
}
...
ERROR_NOT_INTEGER = {
    'code': 'ERROR_{}_NOT_INTEGER',
    'msg': '{} must be integer type.'
}
...
ERROR_NOT_INPUT = {
    'code': 'ERROR_{}_NOT_INPUT',
    'msg': '{} must be input type.'
}
