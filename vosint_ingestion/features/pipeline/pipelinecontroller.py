...
class PipelineController:
    ...
    def get_pipeline_by_id(self, id: str):
        ...
        return {
                'success': True,
                'payload': pipeline_obj
            }
        

    def get_pipelines(self, text_search, enabled, actived, order, page_number, page_size):
        ...
        # Execution at service
        pipeline_dtos, total_records = self.__pipeline_service.get_pipelines(text_search=text_search,
                                                                             enabled=enabled,
                                                                             actived=actived,
                                                                             order=order,
