...
def get_result_job(
    ...
    try:
        if start_date != "" and end_date != "":
            ...
            query["pub_date"] = {"$gt": start_date, "$lt": end_date}
        elif start_date != "":
            start_date = datetime(
                int(start_date.split("/")[2]),
                int(start_date.split("/")[1]),
            ...
            query["pub_date"] = {"$lt": end_date}

        if sac_thai != "" and sac_thai != "all":
            query["data:class_sacthai"] = sac_thai
        ...
        if news_letter_id != "":
            ...
            try:
                ...
                if kt_rong == 1:
                    query[
                        "khong_lay_gi"
                    ] = "bggsjdgsjgdjádjkgadgưđạgjágdjágdjkgạdgágdjka"
        elif vital == "1":
            mongo = MongoRepository().get_one(
