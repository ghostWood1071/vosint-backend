class ParamInfo():
    def __init__(self, name: str, display_name: str, val_type: str, default_val, options: list = [], validators: list = [], z_index: int = 0):
        self.name = name
...
class ActionInfo():
    def __init__(self, name: str, display_name: str, action_type: str, readme: str = '', param_infos: list[ParamInfo] = [], z_index: int = 0):
        self.name = name
        self.display_name = display_name
