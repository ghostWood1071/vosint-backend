...
def feed(url:str=None,link_key:str=rss_version_2_0['link'],title_key:str=rss_version_2_0['titile'],pubDate_key:str=rss_version_2_0['pubDate'],author_key:str=rss_version_2_0["author"]):
    if not url:
        raise InternalError(
...
class FeedAction(BaseAction):
    ...
    def exec_func(self, input_val=None, **kwargs):
        ...
        for data_feed in data_feeds:
            ...
            if author_expr != "None" and author_expr !="" and data_feed['author'] != '':
            ...
            if check_content:
                try:
                    MongoRepository().insert_one(collection_name="News__", doc=news_info)
