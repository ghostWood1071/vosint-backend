...
from ..common import ActionInfo, ParamInfo, SelectorBy, ActionType
...
class GetNewsInfoAction(BaseAction):
    ...
    def get_action_info(cls) -> ActionInfo:
        return ActionInfo(name='get_news_info',
                          ...
                          param_infos=[
                              ParamInfo(name='by',
                                        ...
                                        validators=['required']),
                              ParamInfo(name='title_expr',
                                        display_name='Title Expression',
                                        val_type='str',
                                        default_val='',
                                        validators=['required']),
                              ParamInfo(name='author_expr',
                                        display_name='Author Expression',
                                        val_type='str',
                                        default_val='',
                                        validators=['required']),
                              ParamInfo(name='time_expr',
                                        display_name='Time Expression',
                                        val_type='str',
                                        default_val='',
                                        validators=['required']),
                              ParamInfo(name='content_expr',
